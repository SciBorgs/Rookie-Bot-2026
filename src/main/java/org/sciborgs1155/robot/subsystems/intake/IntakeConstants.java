...
public class IntakeConstants {
  ...
  // place holders...
  public static final double VELOCITY_GAIN = 0.0f;
  public static final double ACCEL_GAIN = 0.0f;

  public static final int EXTENSION = 1; // arm hardware port
  public static final int ROLLER = 2; // intake hardware port

  public static final double GEARING_INTAKE = 2;
